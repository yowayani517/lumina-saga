...
建物は外観を R(屋根)+B(壁)+D(ドア) でみんかを表現。
モンスターセンターは H+K+A、ジムは Y+Z+Q。ドアタイルに warp を置く。
マップに `theme` を付けると内装・まちの色味が変わる (hospital / rock / electric / ghost / champion / moon)。
